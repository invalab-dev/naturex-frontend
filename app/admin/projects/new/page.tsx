...
import { getOrganizations, saveProject, type Project } from "@/lib/data-service"
      ...
      <Card className="w-full max-w-3xl bg-white border-[#E5E7EB] shadow-lg">
        <div className="p-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-[#111827]">새 프로젝트 생성</h1>
          </div>
          <p className="text-[#6B7280] mb-8">조직에 NatureX 서비스를 제공하기 위한 프로젝트를 생성합니다.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
                ...
                <h2 className="text-lg font-semibold text-[#111827]">조직 선택</h2>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-[#6B7280] mt-2">
                  <span>조직이 없으신가요?</span>
                  <Link href="/admin/orgs/new" className="text-[#118DFF] hover:underline font-medium">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
                ...
                <h2 className="text-lg font-semibold text-[#111827]">프로젝트 기본 정보</h2>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
                ...
                <h2 className="text-lg font-semibold text-[#111827]">서비스 테마 선택</h2>
                <span className="text-sm text-red-500 ml-auto">필수</span>
              </div>
                ...
                {themeOptions.map((option) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="font-semibold text-[#111827]">{option.label}</h3>
                      {formData.theme === option.value && (
                    ...
                    <p className="text-xs text-[#9CA3AF]">예: {option.examples}</p>
                  </Card>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
                ...
                <h2 className="text-lg font-semibold text-[#111827]">초기 상태</h2>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-white">
                    <SelectItem value="intake">Intake (데이터 수신 대기)</SelectItem>
                    <SelectItem value="analyzing">Analyzing (분석 중)</SelectItem>
                    <SelectItem value="draft">Draft (임시 저장)</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-sm text-[#6B7280]">대부분의 프로젝트는 Intake 상태로 시작합니다.</p>
              </div>
            </div>
