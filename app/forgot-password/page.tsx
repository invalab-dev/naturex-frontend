    ...
    <div className="min-h-screen bg-[#F5F7FB] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-600">가입하신 이메일 주소를 입력해주세요.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-11"
                />
                <p className="text-xs text-slate-500">비밀번호 재설정 링크를 이메일로 보내드립니다.</p>
              </div>
            ...
            <div className="text-center py-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">이메일을 확인해주세요</h3>
          ...
          {/* Back to Login Link */}
          <div className="mt-6">
            <Link href="/login" className="inline-flex items-center gap-2 text-sm text-[#118DFF] hover:underline">
