...
export function AdminSidebar() {
  ...
  const footerContent = <div className="px-6 py-4 text-xs text-[#9CA3AF]">v1.0.0 · InvaLab Co.</div>

  return <SharedSidebar header={headerContent} navigation={navigationContent} footer={footerContent} fixed />
}
