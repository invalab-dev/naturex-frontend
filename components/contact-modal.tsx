...
export function ContactModal({ open, onOpenChange, language }: ContactModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subjectText = company ? `[NatureX] 문의 - ${company}` : `[NatureX] 문의 - ${name}`
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="name" className="text-sm font-medium text-[#374151]">
              {content.nameLabel[language]} <span className="text-red-500">*</span>
            </Label>
            <Input
              id="name"
              value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="email" className="text-sm font-medium text-[#374151]">
              {content.emailLabel[language]} <span className="text-red-500">*</span>
            </Label>
            <Input
              id="email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="company" className="text-sm font-medium text-[#374151]">
              ...
              <span className="text-xs text-[#6B7280] ml-1">({content.optional[language]})</span>
            </Label>
            <Input
              id="company"
              value={company}
          ...
          <div className="space-y-2">
            <Label htmlFor="message" className="text-sm font-medium text-[#374151]">
              {content.messageLabel[language]} <span className="text-red-500">*</span>
            </Label>
            <Textarea
              id="message"
              value={message}
          ...
          <div className="flex gap-3 pt-4">
            ...
            <Button type="submit" className="flex-1 bg-[#118DFF] hover:bg-[#0F7FE6] text-white font-medium">
