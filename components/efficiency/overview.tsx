...
import { TreeDeciduous, AlertTriangle, TrendingDown, BarChart3, Activity, Database } from "lucide-react"
import {
  LineChart,
  Line,
  BarChart,
...
export function EfficiencyOverview() {
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-sm font-medium text-muted-foreground">총 수목/자산 수</h3>
          </div>
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-sm font-medium text-muted-foreground">건강지수 평균</h3>
          </div>
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-sm font-medium text-muted-foreground">위험도 분포</h3>
          </div>
        ...
        <div className="rounded-xl border border-emerald-700 bg-emerald-500/5 p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-sm font-medium text-emerald-300">예상 비용 절감율</h3>
          </div>
          <p className="text-3xl font-bold text-emerald-400">43%</p>
          <p className="text-xs text-emerald-300/70 mt-1">연간 약 2.8억원 절감 가능</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-foreground">Hotspot Count</h3>
          </div>
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-foreground">데이터 출처</h3>
          </div>
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
              <span className="text-slate-300">드론 RGB 정사영상 (Orthomosaic)</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-300">Multispectral TIFF (NDVI/NDRE)</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-orange-400"></span>
              <span className="text-slate-300">수목 현황 CSV (TreeID, XY, DBH)</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Health Score / Risk Score Timeline</h3>
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={healthScoreData}>
            ...
            />
            <Legend />
            <Line type="monotone" dataKey="health" stroke="#10b981" strokeWidth={2} name="건강지수" />
            <Line type="monotone" dataKey="risk" stroke="#ef4444" strokeWidth={2} name="위험도" />
          </LineChart>
        </ResponsiveContainer>
      </div>

      <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">NDVI / NDRE Index Summary</h3>
        <ResponsiveContainer width="100%" height={300}>
