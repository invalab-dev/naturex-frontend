...
export function AssetsStepHome({ language }: AssetsStepHomeProps) {
  const features = [
    ...
    },
    {
      ...
      descEn:
        "Assess quantified value including carbon storage and productivity",
    },
    {
      icon: BarChart3,
      titleKr: "최적화 분석",
      ...
      <Card className="border-slate-700 bg-slate-900/50">
        <CardHeader>
          <CardTitle className="text-xl">
            {language === "kr"
              ? "자산 가치 향상 서비스 소개"
              : "Asset Value Enhancement Service"}
          </CardTitle>
        </CardHeader>
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-lg">
                    {language === "kr" ? feature.titleKr : feature.titleEn}
                  </CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {language === "kr" ? feature.descKr : feature.descEn}
                </p>
              </CardContent>
            </Card>
          );
