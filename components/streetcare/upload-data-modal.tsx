    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>Upload drone images, LiDAR files, or multispectral data for analysis</DialogDescription>
        </DialogHeader>
        ...
        {!isUploaded ? (
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">Supports: .jpg, .png, .tif, .las, .laz</p>
            </div>
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">New tree data has been uploaded and is being processed</p>
          </div>
        )}
      </DialogContent>
    </Dialog>
