  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Comprehensive tree management dashboard</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Urgent Action Required</CardTitle>
            <AlertCircle className="h-4 w-4 text-destructive" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-destructive">23</div>
            <p className="text-xs text-muted-foreground mt-1">Trees requiring immediate attention</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Trees due for inspection this month</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Detected Pest Types</CardTitle>
            <Bug className="h-4 w-4 text-primary" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">7</div>
            <p className="text-xs text-muted-foreground mt-1">Active pest species identified</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Health Grade Distribution</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
                <Pie data={healthData} cx="50%" cy="50%" outerRadius={100} dataKey="value" label>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={trendData}>
              ...
              <Tooltip />
              <Legend />
              <Line yAxisId="left" type="monotone" dataKey="height" stroke="#10b981" name="Height (m)" />
              <Line yAxisId="right" type="monotone" dataKey="dbh" stroke="#3b82f6" name="DBH (cm)" />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="aspect-video bg-muted rounded-md flex items-center justify-center">
              <img src="/city-map-with-tree-locations-markers.jpg" alt="City map" className="w-full h-full object-cover rounded-md" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex justify-between items-center pb-2 border-b">
              <span className="text-sm text-muted-foreground">Drone Images</span>
              <span className="font-medium">4,850 images</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b">
              <span className="text-sm text-muted-foreground">Manual Inspections</span>
              <span className="font-medium">987 reports</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b">
              <span className="text-sm text-muted-foreground">Pest Detection AI</span>
