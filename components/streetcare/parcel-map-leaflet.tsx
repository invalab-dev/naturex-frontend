  ...
  return (
    <div className="relative w-full h-full bg-slate-950 rounded-lg border border-border overflow-hidden">
        ...
        <div className="mt-1.5 flex items-center gap-3 text-[10px]">
          <span className="text-muted-foreground">
            ...
            <span className="text-foreground font-medium">
              {selectedParcel.treeCount}
            </span>
          </span>
          <span className="text-muted-foreground">
            High Risk:{" "}
            <span className="text-destructive font-medium">
              {selectedParcel.highRiskCount}
            </span>
          </span>
        </div>
      </div>
      ...
      <div className="absolute bottom-3 left-3 bg-background/95 backdrop-blur-sm border rounded-lg p-2.5 text-xs space-y-1 z-10 shadow-xl">
        <div className="font-semibold mb-1.5 text-[10px] text-muted-foreground">
          RISK LEVEL
        </div>
      ...
      >
        ...
        <rect
          width="1000"
          height="500"
          fill={mapLayer === "terrain" ? "url(#terrain-texture)" : mapStyle.bg}
        />
        <rect width="1000" height="500" fill="url(#grid)" />

        <g
          stroke={mapStyle.roadColor}
          strokeWidth={mapLayer === "satellite" ? "4" : "3"}
          fill="none"
          opacity="0.8"
        >
          ...
          return (
            <g key={parcel.id}>
              ...
              <path
                ...
                strokeDasharray={
                  isSelected ? "none" : isHovered ? "8,4" : "none"
                }
