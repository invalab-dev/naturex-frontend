              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className="bg-purple-500/10 text-purple-500 text-[10px] px-1 py-0"
                    >
                      InvaLab
                    </Badge>
                  </div>
                  <Switch
                    id="rgb"
                    checked={selectedLayer === "rgb"}
                    onCheckedChange={() => setSelectedLayer("rgb")}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className="bg-emerald-500/10 text-emerald-500 text-[10px] px-1 py-0"
                    >
                      AI
                    </Badge>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    id="dem"
                    checked={selectedLayer === "dem"}
                    onCheckedChange={() => setSelectedLayer("dem")}
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    id="chm"
                    checked={selectedLayer === "chm"}
                    onCheckedChange={() => setSelectedLayer("chm")}
                  />
                </div>
              </div>
            </div>
                ...
                {selectedTree ? (
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        {getRiskBadge(selectedTree.riskLevel)}
                      </div>
                    </div>
