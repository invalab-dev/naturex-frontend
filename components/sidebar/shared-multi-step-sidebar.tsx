...
export function SharedMultiStepSidebar<T extends string>({
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={cn("p-4 border-b flex items-center justify-between", theme.containerBorder.replace("border-r", ""))}
      >
        {!collapsed && (
          <div>
        ...
        <Button
          ...
          className={cn("h-8 w-8 p-0", theme.toggleButtonColor, theme.toggleButtonHoverColor)}
        >
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isActive && cn(theme.activeIconBg, theme.activeIconText, theme.activeIconRing),
                  isCompleted && !isActive && cn(theme.completedIconBg, theme.completedIconText),
                  !isActive && !isCompleted && cn(theme.inactiveIconBg, theme.inactiveIconText),
                )}
              >
              ...
              {!collapsed && (
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className={cn("text-xs font-semibold", theme.stepNumberText)}>STEP {index + 1}</span>
                  </div>
                  <h3
                    className={cn("font-semibold text-sm mt-1", isActive ? theme.activeStepText : theme.inactiveStepText)}
                  >
...
export const efficiencyTheme: MultiStepSidebarTheme = {
  ...
  headerTitleColor: "bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent",
  ...
  activeStepBg: "bg-gradient-to-r from-blue-500 to-indigo-500 shadow-md border-0 text-white",
