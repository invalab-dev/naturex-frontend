...
import { Home, MapPin, BarChart3, FileText, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        {!collapsed && (
          <div>
            <h2 className="text-sm font-bold text-slate-200">{language === "kr" ? "ESG·TNFD" : "ESG·TNFD"}</h2>
            ...
            >
              <div
                className={cn(
                  ...
                  isCompleted && !isActive && "bg-blue-500/10 text-blue-500",
              ...
              {!collapsed && (
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className={cn("font-semibold text-sm mt-1", isActive ? "text-blue-400" : "text-slate-200")}>
