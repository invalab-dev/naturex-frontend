        ...
        <CardContent>
          <div className="flex items-center gap-6">
            <ResponsiveContainer width="60%" height={200}>
              <PieChart>
                <Pie data={habitatData} dataKey="value" cx="50%" cy="50%" innerRadius={50} outerRadius={80}>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Number of Patches</span>
              <span className="text-sm font-semibold">143</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Mean Patch Size</span>
              <span className="text-sm font-semibold">0.89 ha</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Fragmentation Score</span>
